...
char maze[102][102];
int minTurns[102][102][4];  // 0: x, 1: y, 2: turns
int pre[102][102][4][3];    // 0: x, 1: y, 2: dir, 3: from_x, from_y,  from_dir
int q[40001][4];            // 0: x 1: y 2: dir 3: turns
int n, head, tail;
